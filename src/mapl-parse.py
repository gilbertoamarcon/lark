...
from MaplDomainTransformer import MaplDomainTransformer
from MaplProblemTransformer import MaplProblemTransformer
import argparse
...
def main():
	...
	if args.yaml_domain_file is None:
		...
		# Parsing domain
		database = MaplDomainTransformer().transform(tree)
		...
		# Parsing problem
		database = MaplProblemTransformer(domain).transform(tree)
